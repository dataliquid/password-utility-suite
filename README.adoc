...
image:https://img.shields.io/badge/Java-17%2B-ED8B00?logo=openjdk&logoColor=white[Java 17+]
image:https://img.shields.io/badge/Maven-3.9%2B-C71A36?logo=apache-maven&logoColor=white[Maven 3.9+]
